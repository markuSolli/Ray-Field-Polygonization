...
sphere_points: ndarray = utils.generate_equidistant_sphere_points(N_SPHERE_POINTS, SPHERE_RADIUS)
...
with o3d.utility.VerbosityContextManager(o3d.utility.VerbosityLevel.Debug) as cm:
    generated_mesh, densities = o3d.geometry.TriangleMesh.create_from_point_cloud_poisson(point_cloud, depth=POISSON_DEPTH)
