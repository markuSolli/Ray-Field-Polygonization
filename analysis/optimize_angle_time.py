...
DIR_PATH = 'analysis/data/optimize_angle_time/'
...
def save_results(M_values: list[float], R_values: list[list[int]], times: list[list[float]], model_name: str) -> None:
...
def plot_results(M_values: list[float], R_values: list[list[int]], times: list[list[float]], model_name: str) -> None:
    fig, ax = plt.subplots()
...
if args.Load:
    ...
    M_values, R_values, times = compute_values(args.Filename)
